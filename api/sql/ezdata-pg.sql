...
insert into sys_menu values(2302, '数据看板', 2300, '2', 'dashboard', 'dataManage/visualization/index', '', '', 1, 0, 'C', '0', '0', 'data:query',        'chart',    'admin', current_timestamp, '', null, 'ECharts 看板管理(取数+声明式图表,可复用)');

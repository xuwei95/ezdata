...
('seed-demo-es', '演示-Elasticsearch', 'demo_es', 'elasticsearch', 'search', '{"hosts": "http://ezdata-es:9200", "user": "elastic", "password": "ezdata123456"}', null, 'ok', '内置 ES(演示,可作 ETL 目标 / 数据服务;账号 elastic/ezdata123456)', 'admin', current_timestamp, 100);

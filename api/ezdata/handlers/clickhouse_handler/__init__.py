...
from ezdata.handlers.clickhouse_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.clickhouse_handler.clickhouse_handler import ClickHouseHandler

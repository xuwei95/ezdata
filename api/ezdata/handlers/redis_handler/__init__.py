...
from ezdata.handlers.redis_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.redis_handler.redis_handler import RedisHandler

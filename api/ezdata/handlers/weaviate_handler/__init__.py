...
from ezdata.handlers.weaviate_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.weaviate_handler.weaviate_handler import WeaviateHandler

...
from ezdata.handlers.mariadb_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.mariadb_handler.mariadb_handler import MariaDBHandler

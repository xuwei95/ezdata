...
from ezdata.handlers.trino_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.trino_handler.trino_handler import TrinoHandler
    return TrinoHandler

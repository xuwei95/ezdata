...
from ezdata.handlers.gcs_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.gcs_handler.gcs_handler import GCSHandler

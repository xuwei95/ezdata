...
from ezdata.handlers.dynamodb_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.dynamodb_handler.dynamodb_handler import DynamoDBHandler

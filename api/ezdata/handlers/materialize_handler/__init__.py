...
from ezdata.handlers.materialize_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.materialize_handler.materialize_handler import MaterializeHandler

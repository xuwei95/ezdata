...
from ezdata.handlers.pinecone_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.pinecone_handler.pinecone_handler import PineconeHandler

...
connection_args = OrderedDict(
    hosts={'type': ARG_TYPE.STR, 'description': '节点地址,多个用逗号分隔,如 host1:9200,host2:9200。',
           'required': False, 'label': 'Hosts'},
    cloud_id={'type': ARG_TYPE.STR, 'description': 'Elastic Cloud ID(与 hosts 二选一)。',
              'required': False, 'label': 'Cloud ID'},

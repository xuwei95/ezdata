...
from ezdata.handlers.pinot_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.pinot_handler.pinot_handler import PinotHandler

...
from ezdata.handlers.tdengine_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.tdengine_handler.tdengine_handler import TDengineHandler

...
connection_args = OrderedDict(
    uri={'type': ARG_TYPE.STR, 'description': 'Bolt URI,如 bolt://host:7687 或 neo4j://host:7687。',
         'required': True, 'label': 'URI'},
...
connection_args_example = OrderedDict(uri='bolt://127.0.0.1:7687', username='neo4j', password='password',
                                      database='neo4j')

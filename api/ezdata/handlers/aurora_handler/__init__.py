...
from ezdata.handlers.aurora_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.aurora_handler.aurora_handler import AuroraHandler

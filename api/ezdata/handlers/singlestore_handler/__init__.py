...
from ezdata.handlers.singlestore_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.singlestore_handler.singlestore_handler import SingleStoreHandler

    return SingleStoreHandler

...
from ezdata.handlers.supabase_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.supabase_handler.supabase_handler import SupabaseHandler

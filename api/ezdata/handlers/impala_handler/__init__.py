...
from ezdata.handlers.impala_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.impala_handler.impala_handler import ImpalaHandler

    return ImpalaHandler

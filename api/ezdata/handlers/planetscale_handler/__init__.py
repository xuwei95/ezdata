...
from ezdata.handlers.planetscale_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.planetscale_handler.planetscale_handler import PlanetScaleHandler

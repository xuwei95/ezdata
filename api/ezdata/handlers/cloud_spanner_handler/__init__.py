...
from ezdata.handlers.cloud_spanner_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.cloud_spanner_handler.cloud_spanner_handler import CloudSpannerHandler
    return CloudSpannerHandler

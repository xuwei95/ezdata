...
from ezdata.handlers.druid_handler.connection_args import connection_args, connection_args_example
...
def load_handler():
    ...
    from ezdata.handlers.druid_handler.druid_handler import DruidHandler
    return DruidHandler

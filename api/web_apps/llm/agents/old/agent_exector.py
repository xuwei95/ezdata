...
Use web_apps.llm.utils.ObjectSerializer instead.

The functionality has been migrated to:
- ObjectSerializer: web_apps/llm/utils/object_serializer.py
- ToolsCallAgent: web_apps/llm/agents/tools_call_langgraph.py
"""
import json
from abc import ABC
...
from langchain_community.agent_toolkits.load_tools import InvalidTool
from typing import (
    Dict,
    Optional,
    Tuple,

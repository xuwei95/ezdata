...
Use web_apps.llm.agents.tools_call_langgraph.ToolsCallAgent instead.
...
class ToolsCallAgent:
    ...
    def __init__(self, tools, llm=None, system_prompt=''):
        ...
        self.agent = create_agent(model=self.llm, tools=tools, system_prompt=self.system_prompt)

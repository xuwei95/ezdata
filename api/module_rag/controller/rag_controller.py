...
# ---------------- 知识库 ----------------
@rag_controller.get(
    '/dataset/list', summary='知识库列表', dependencies=[UserInterfaceAuthDependency('rag:dataset:list')]
)
async def dataset_list(
    request: Request,
    db: Annotated[AsyncSession, DBSessionDependency()],
    name: Annotated[str | None, Query()] = None,
    pageNum: Annotated[int, Query()] = 1,
    pageSize: Annotated[int, Query()] = 10,
    includeSource: Annotated[bool, Query()] = False,
) -> Response:
    return ResponseUtil.success(
        model_content=await DatasetService.get_list(
...
async def dataset_by_source(
    ...
    sourceCode: Annotated[str | None, Query()] = None,
) -> Response:
    return ResponseUtil.success(
...
@rag_controller.get(
    '/dataset/{ds_id}', summary='知识库详情', dependencies=[UserInterfaceAuthDependency('rag:dataset:list')]
)
...
@rag_controller.put(
    '/dataset/{ds_id}', summary='编辑知识库', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
async def dataset_update(
    ds_id: Annotated[str, Path()],
    req: DatasetUpdateReq,
    db: Annotated[AsyncSession, DBSessionDependency()],
    current_user: Annotated[CurrentUserModel, CurrentUserDependency()],
) -> Response:
...
@rag_controller.delete(
    '/dataset/{ids}', summary='删除知识库', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
...
# ---------------- 文档 ----------------
@rag_controller.get(
    '/document/list', summary='文档列表', dependencies=[UserInterfaceAuthDependency('rag:dataset:list')]
)
async def document_list(
    request: Request,
    db: Annotated[AsyncSession, DBSessionDependency()],
    datasetId: Annotated[str, Query()],
    name: Annotated[str | None, Query()] = None,
    pageNum: Annotated[int, Query()] = 1,
    pageSize: Annotated[int, Query()] = 10,
) -> Response:
...
@rag_controller.delete(
    '/document/{ids}', summary='删除文档', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
...
@rag_controller.post(
    '/document/{doc_id}/train', summary='训练文档', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
async def document_train(
    doc_id: Annotated[str, Path()], db: Annotated[AsyncSession, DBSessionDependency()]
) -> Response:
...
@rag_controller.get(
    '/document/{doc_id}/status', summary='文档训练状态', dependencies=[UserInterfaceAuthDependency('rag:dataset:list')]
)
...
async def chunk_list(
    ...
    db: Annotated[AsyncSession, DBSessionDependency()],
    datasetId: Annotated[str, Query()],
    documentId: Annotated[str | None, Query()] = None,
    chunkType: Annotated[str | None, Query()] = None,
    keyword: Annotated[str | None, Query()] = None,
    pageNum: Annotated[int, Query()] = 1,
    pageSize: Annotated[int, Query()] = 10,
) -> Response:
    return ResponseUtil.success(
        model_content=await ChunkService.get_list(
            db, datasetId, documentId, pageNum, pageSize, is_page=True, chunk_type=chunkType, keyword=keyword
        )
    )
...
@rag_controller.delete(
    '/chunk/{ids}', summary='删除分段', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
...
@rag_controller.post(
    '/chunk/{chunk_id}/star', summary='分段标星', dependencies=[UserInterfaceAuthDependency('rag:dataset:edit')]
)
...
async def retrieval(
    request: Request, req: RetrievalReq, db: Annotated[AsyncSession, DBSessionDependency()]
) -> Response:
    return ResponseUtil.success(data=await RetrievalService.search(db, req))


@rag_controller.get(
    '/vector/backends', summary='支持的向量后端', dependencies=[UserInterfaceAuthDependency('rag:dataset:list')]
)

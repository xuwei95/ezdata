<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="118px">
         <el-form-item :label="$t('操作地址')" prop="operIp">
            <el-input
               v-model="queryParams.operIp"
               :placeholder="$t('请输入操作地址')"
               clearable
               style="width: 240px;"
      ...
      <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
         ...
         <el-table-column :label="$t('系统模块')" align="center" prop="title" :show-overflow-tooltip="true" />
         <el-table-column :label="$t('操作类型')" align="center" prop="businessType">
            <template #default="scope">
               <dict-tag :options="sys_oper_type" :value="scope.row.businessType" />
            </template>
         </el-table-column>
         <el-table-column :label="$t('操作人员')" align="center" width="110" prop="operName" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']" />
         <el-table-column :label="$t('操作地址')" align="center" prop="operIp" width="130" :show-overflow-tooltip="true" />
         <el-table-column :label="$t('操作状态')" align="center" prop="status">
            <template #default="scope">
               <dict-tag :options="sys_common_status" :value="scope.row.status" />
            </template>
         </el-table-column>
         <el-table-column :label="$t('操作日期')" align="center" prop="operTime" width="180" sortable="custom" :sort-orders="['descending', 'ascending']">
            <template #default="scope">
               <span>{{ parseTime(scope.row.operTime) }}</span>
            </template>
         </el-table-column>
         <el-table-column :label="$t('消耗时间')" align="center" prop="costTime" width="110" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']">
            <template #default="scope">
         ...
         <el-table-column :label="$t('操作')" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="View" @click="handleView(scope.row, scope.index)" v-hasPermi="['monitor:operlog:query']">{{ $t('详细') }}</el-button>
            </template>
         </el-table-column>
      </el-table>
      ...
      <el-dialog :title="$t('操作日志详细')" v-model="open" width="800px" append-to-body>
         <el-form :model="form" label-width="150px">
            <el-row>
               ...
               <el-col :span="24">
                  <el-form-item :label="$t('请求参数：')" style="word-break: break-all; white-space: pre-wrap;">{{ form.operParam }}</el-form-item>
               </el-col>
               <el-col :span="24">
               ...
               <el-col :span="8">
                  <el-form-item :label="$t('消耗时间：')">{{ form.costTime }}毫秒</el-form-item>
               </el-col>
               <el-col :span="8">

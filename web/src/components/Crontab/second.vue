<template>
    <el-form>
        <el-form-item>
            <el-radio v-model='radioValue' :value="1"> {{ $t('秒，允许的通配符[, - * /]') }} </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3"> {{ $t('从') }} <el-input-number v-model='average01' :min="0" :max="58" /> {{ $t('秒开始，每') }} <el-input-number v-model='average02' :min="1" :max="59 - average01" /> {{ $t('秒执行一次') }} </el-radio>
        </el-form-item>
